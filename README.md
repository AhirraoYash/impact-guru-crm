...
git clone [https://github.com/YOUR_USERNAME/impact-guru-crm.git](https://github.com/YOUR_USERNAME/impact-guru-crm.git)
cd impact-guru-crm
...
3. Environment Setup
Rename the example environment file and generate the key:
...
4. Database Setup
Create a database named impact_guru_crm (or your preferred name) in MySQL/HeidiSQL.
...
👤 User Roles & Testing
You can register a new account and assign roles in the database (users table).
